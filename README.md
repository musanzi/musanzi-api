...
NestJS API musanzi for session-based authentication, Google OAuth, role-based access control, user and role management, aggregate stats, CSV user import/export, local avatar uploads, password reset emails, and PostgreSQL persistence with TypeORM.
...
- Local seed script for musanzi admin and user credentials
  ...
  src/
    ...
    modules/
      ...
      database/
        ...
        seeds/                  # musanzi admin/user seed data
