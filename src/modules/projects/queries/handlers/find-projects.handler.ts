...
export class FindProjectsHandler implements IQueryHandler<FindProjectsQuery, [Project[], number]> {
  ...
  async execute(query: FindProjectsQuery): Promise<[Project[], number]> {
    try {
